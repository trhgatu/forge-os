...
export function MemoryDetailPanel({
  ...
  return (
    <div
      className={cn(
        "fixed inset-y-0 right-0 z-100 flex w-full flex-col border-l bg-black/90 shadow-2xl backdrop-blur-2xl md:w-[500px] animate-in slide-in-from-right duration-700 ease-spring-out",
        config.border
      )}
    >
      {/* ambience */}
